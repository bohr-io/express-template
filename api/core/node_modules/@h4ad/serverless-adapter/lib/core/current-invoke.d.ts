 ...
 * @public
 */
export declare type CurrentInvoke<TEvent, TContext> = {
    /**
 ...
 * @public
 */
export declare function setCurrentInvoke<TEvent = any, TContext = any>({ event, context, }: CurrentInvoke<TEvent, TContext>): void;
export declare type __ΩCurrentInvoke = any[];
