 ...
 * @public
 */
export declare type Resolver<TResponse, TReturn> = {
    /**
 ...
 * @public
 */
export declare type DelegatedResolver<TResponse> = {
    /**
 ...
 * @public
 */
export declare type ResolverProps<TEvent, TContext, TCallback, TResponse> = {
    /**
...
export declare type __ΩDelegatedResolver = any[];
export declare type __ΩResolverProps = any[];
export declare type __ΩResolverContract = any[];
