...
export declare type __ΩAdapterRequest = any[];
export declare type __ΩGetResponseAdapterProps = any[];
export declare type __ΩOnErrorProps = any[];
export declare type __ΩAdapterContract = any[];
