 ...
 * @public
 */
export declare type BinarySettings = BinarySettingsFunction | BinarySettingsContentHeaders;
export declare type __ΩBinarySettingsFunction = any[];
export declare type __ΩBinarySettingsContentHeaders = any[];
export declare type __ΩBinarySettings = any[];
