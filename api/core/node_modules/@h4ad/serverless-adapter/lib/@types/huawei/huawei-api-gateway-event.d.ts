 ...
 * @breadcrumb Types / Huawei / HuaweiApiGatewayEvent
 */
export declare type HuaweiRequestPathParameters = Record<string, string>;
/**
 ...
 * @breadcrumb Types / Huawei / HuaweiApiGatewayEvent
 */
export declare type HuaweiRequestQueryStringParameters = Record<string, string | string[]>;
/**
...
export declare type __ΩHuaweiApiGatewayEvent = any[];
export declare type __ΩHuaweiRequestPathParameters = any[];
export declare type __ΩHuaweiRequestQueryStringParameters = any[];
export declare type __ΩHuaweiRequestContext = any[];
